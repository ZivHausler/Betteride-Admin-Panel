...
const VehicleInfo = ({setMapCenter, state, currentLocation, precentage, plateNumber }) => {
   
    return (
        <div className='select-none w-[90%] h-24 bg-white my-[4px] shadow-md rounded-xl flex flex-col justify-between p-2 text-sm hover:scale-[105%] hover:bg-gray-100 transition ease-in-out duration-200 '>
            <div className='flex justify-between px-2 items-center'>
                ...
                <Image onClick={() => setMapCenter({lat:currentLocation.location.lat, lng:currentLocation.location.lng})} className='hover:scale-110 transition cursor-pointer ease-in-out duration-20 ' src="/target_icon.png" width={25} height={25} />
            </div>
            <div >
